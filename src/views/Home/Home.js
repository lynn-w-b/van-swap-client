...
const Home = (props) => {
  console.log(props);
  const { fullname, dateofbirth, location, about, image } = props.user;
  return (
    <div>
      <NavBar
        button1="My Van"
      ...
      <div className="textbox">
        ...
        <img src={image && props.user.image} alt="van" />
      </div>
      <div className="titlecontainer">
      ...
      <div className="textbox">
        <p>
          This is where the swap requests will go linked to the swap request
          form
        </p>
      </div>
      <div className="titlecontainer">
